...
function Cart ({ total, updateBird, deleteBird }) {
    ...
    return (
      <div className="Cart">
        <h1>Cart</h1>
        <h3>Discount: {(updateBird.length > 2) ? 10 : 0}%</h3>
        <h4>Total: ${(updateBird.length > 2) ? total - (total * 0.10) : total}</h4>
        <div>
            <ol>
                {updateBird.map((birdInfo, index) => {
